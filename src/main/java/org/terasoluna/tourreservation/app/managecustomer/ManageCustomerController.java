...
import org.terasoluna.tourreservation.domain.model.CustomerBuilder;
...
public class ManageCustomerController {
	...
	private static final Logger log = LoggerFactory.getLogger(ManageCustomerController.class);
	...
	public ManageCustomerController(CustomerService customerService,
			CustomerPassEqualsValidator passwordEqualsValidator, CustomerBirthdayValidator dateValidator,
