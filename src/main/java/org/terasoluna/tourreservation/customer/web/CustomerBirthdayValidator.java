...
public class CustomerBirthdayValidator implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		try {
			LocalDate ignored = LocalDate.of(customer.getCustomerBirthYear(), customer.getCustomerBirthMonth(),
					customer.getCustomerBirthDay());
		}
		catch (DateTimeException e) {
			errors.rejectValue("customerBirthYear", "IncorrectDate.customerBirth", "Incorrect date was entered.");
		}
