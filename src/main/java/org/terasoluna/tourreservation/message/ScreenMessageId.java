 ...
 */
package org.terasoluna.tourreservation.message;

/** This file was automatically generated. */
public final class ScreenMessageId {
	...
	/**
	 * <strong>label.tr.menu.tourSearchMessage = You can search tours with the specified
	 * conditions. <br>
	...
	/**
	 * <strong>label.tr.menu.customerRegisterMessage = Enter your information to register
	 * membership</strong>
	 */
	...
	/**
	 * <strong>label.tr.managecustomer.createFormMessage = <strong>Membership information
	 * input</strong> -> Confirm information -> Completed<br>
	...
	/**
	 * <strong>label.tr.managecustomer.createConfirmMessage = Membership information input
	 * -> <strong>Confirm information</strong> -> Completed<br>
	...
	/**
	 * <strong>label.tr.managecustomer.createCompleteMessage = Membership information
	 * input -> Confirm information -> <strong>Completed</strong><br>
	...
	/**
	 * <strong>label.tr.managecustomer.halfTelOnlyMessage = Half-width 10 digits to 13
	 * digits numeric only</strong>
	 */
	...
	/**
	 * <strong>label.tr.managecustomer.halfPasswordOnlyMessage = Half-width 4 digits to 20
	 * digits alphanumeric only</strong>
	 */
	 ...
	 * <li>Please select one tour fromLocalDate the search results list.</li>
	 * <li>Check the contents of the tour in Tour Details screen, please proceed to the
	 * next screen if there is no problem. (Reservations are not yet.)</li>
	 * <li>Confirm your reservation, please perform a reservation if there is no
	 * problem.</li>
	 * <li>For more information please check tour, membership information, fee details,
	 * the payment information screen tour reservation registration is complete.</li>
	 * </ol>
	 * <p>
	 * Search for tours by specifying the conditions, please select a tour fromLocalDate
	 * the search results. The tour can be selected by pressing the link name of the tour.
	 * </p>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.searchtour.depDateRestrictMessage = Please enter dates in the
	 * future after one week fromLocalDate today</strong>
	 */
	...
	/**
	 * <strong>label.tr.searchtour.searchTourResultMessage = Tour Search Result (sorted by
	 * tour days, base price)</strong>
	 */
	...
	/**
	 * <strong>label.tr.searchtour.tourDetailCaptionMessage = Detail Information of the
	 * Tour</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_TOURDETAILCAPTIONMESSAGE = "label.tr.searchtour.tourDetailCaptionMessage";

	/**
	 * <strong>label.tr.searchtour.loginToReserveMessage = Please press the Login button
	 * below in order to make the reservation</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_LOGINTORESERVEMESSAGE = "label.tr.searchtour.loginToReserveMessage";

	/**
	 * <strong>label.tr.searchtour.pressReserveBtnMessage = Once the Tour details are
	 * confirmed, please press the Reserve button below. </br>
	...
	/**
	 * <strong>label.tr.searchtour.opinionSuggestionMessage = * If there is opinion or
	 * suggestion regarding the tour, please mention it here</strong>
	 */
	...
	/**
	 * <strong>label.tr.searchtour.searchtourReservePdfMessage = Return to Tour Search
	 * Screen</strong>
	 */
	 ...
	 * Search&nbsp;⇒&nbsp;<strong>Tour Details</strong>&nbsp;⇒&nbsp;Confirmation of Tour
	 * Details&nbsp;⇒&nbsp;Finish</strong>
	 */
	public static final String LABEL_TR_SEARCHTOUR_GOTOURSEARCHSCREENMESSAGE = "label.tr.searchtour.goTourSearchScreenMessage";

	/**
	 * <strong>label.tr.managereservation.manageReservationMessage = Refer Reservations
	 * Screen</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationFlowMessage = <strong>Confirm
	 * the List of Reservations </strong> ⇒ Confirm the Details</br>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationNoRecordMessage = For refering
	 * the details or making changes to a reservation or canceling a reservation, <br />
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationNoCancelMessage = The Tours for
	 * which the payment has been done or payment due date has already passed, <br />
	 ...
	 * List&nbsp;&nbsp; <font>※Shown in the ascending order of departure and reservation
	 * no</font></strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.changeReservationFinBtnMessage = Finalize the
	 * Changes</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.changeReservationStaBtnMessage = Start Over
	 * Again</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.returnToListScreenBtnMessage = Return to List of
	 * Reservations</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.updatedFinishMessage = The reservation has been
	 * changed as below.<br>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.paymentReminderMessage = Please make the payment
	 * at the reception or in the bank account before the payment due-date.<br />
	 * Also, please note that if payment is not done by the due-date, it is possible that
	 * the reservation may get cancelled.<br />
	...
	/**
	 * <strong>label.tr.managereservation.paymentNoCancelMessage = The payment for this
	 * reservation has been done.<br />
	 * Thereby, this reservation cannot be changed or cancelled fromLocalDate the
	 * web.<br />
	 * Please visit the travel desk or contact us on phone at (01-2345-6789) for changes
	 * and cancellation related procedures<br />
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.updatedCompleteMessage = Reservation is changed
	 * as above.</strong>
	 */
	 ...
	 * <font>Confirm the list of reservations</font>&nbsp;⇒&nbsp; <font><strong>Confirm
	 * the details of a Reservation</strong></font></strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.manageReservationShowMessage = Please confirm
	 * the detail information of the reservation made by you.<br />
	 * </strong>
	 */
	 ...
	 * <p>
	 * If there is no problem with the changed contents, press the "Change Reservation"
	 * button below.&nbsp;
	 * </p>
	 * </strong>
	 */
	 ...
	 * <p>
	 * After making changes to the reservation, press the "Confirm Reservation" button
	 * below.&nbsp;
	 * </p>
	 * </strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.beforecancelScreenTitleMessage = Confirmation
	 * Screen for Reservation Cancellation</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.beforecancelScreenFlowMessage = <strong>Confirm
	 * Cancellation Contents</strong>&nbsp;⇒&nbsp;Finish</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.beforeCancelScreenMessage = Please Press "Cancel
	 * Reservation" button below if this reservation is to be cancelled.</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.aftercancelScreenTitleMessage = Reservation
	 * Cancellation Screen</strong>
	 */
	...
	/**
	 * <strong>label.tr.managereservation.aftercancelScreenMessage = Tour Reservation with
	 * Reservation Number: {0}, is cancelled.</strong>
	 */
