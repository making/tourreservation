...
class ManageCustomerControllerTest {
	...
	void setUp() {
		...
		ManageCustomerController manageCustomerController = ManageCustomerControllerBuilder.manageCustomerController()
			.customerService(customerService)
		...
		// build
		mockMvc = standaloneSetup(manageCustomerController).build();
	}
